/**
 * Expo config plugin — injects iOS PrivacyInfo.xcprivacy
 *
...
/** Full PrivacyInfo.xcprivacy plist content */
...
<dict>
  ...
  <array>
    ...
    <!-- Precise location (for nearby merchant discovery) -->
    <dict>
      <key>NSPrivacyCollectedDataType</key>
  ...
  <array>
    ...
    <!-- File timestamp (expo-file-system reads file timestamps) -->
    <dict>
      <key>NSPrivacyAccessedAPIType</key>
    ...
    <!-- Disk space (Metro / expo-file-system may check available disk) -->
    <dict>
      <key>NSPrivacyAccessedAPIType</key>
    ...
    <!-- System boot time (some RN internals use it for timers) -->
    <dict>
      <key>NSPrivacyAccessedAPIType</key>
