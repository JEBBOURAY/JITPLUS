...
const WELCOME_DAY1: Record<Lang, {
  ...
  ar: {
    ...
    p1: (b) => `عشرات المحلات الشركاء كيتسناوك ف <strong style="color: ${b};">JitPlus</strong>. قهاوي، ريسطوران، صالونات، حوانت&hellip; اربح نقط ف كل زيارة!`,
    bullets: [
...
const WELCOME_DAY3: Record<Lang, {
  ...
  ar: {
    ...
    p1: (b) => `واش كنتي تعرف بلي <strong>كل شراء</strong> عند تاجر شريك كيجيب ليك نقط؟ غير وري <strong style="color: ${b};">QR كود ديال JitPlus</strong> للتاجر.`,
...
const WELCOME_DAY7: Record<Lang, {
  ...
  ar: {
    pre: 'عيّط لصحابك على JitPlus واربحو بجوج!',
    h: '🎁 بارطاجي واربح!',
    p1: (b) => `كتعجبك JitPlus؟ بارطاجيها مع صحابك واربحو كادوات! ملي واحد من صحابك يتسجل بكود ديالك، تاتوصلو بجوج ب<strong style="color: ${b};">بونوس خاص</strong>.`,
    bonus: '💰 25 درهم بونوس',
...
const REENGAGE_30D: Record<Lang, { pre: string; h: string; p1: string; p2: string; cta: string; }> = {
  ...
  ar: {
    pre: 'كتخصرنا! عروض جديدة كتسناك ف JitPlus.',
    h: '😢 كتخصرنا!',
    p1: 'هادي 30 يوم ما استعملتيش JitPlus. خلال هاد الوقت، محلات جداد دخلو للمنصة، وكادوات جداد كيتسناوك!',
    p2: 'رجع اكتشف كل اللي وجدنا ليك. بالحق، كيسوا العناء! 💜',
    cta: 'رجع اكتشف JitPlus',
  },
};
...
const WEEKLY_DIGEST: Record<Lang, {
  ...
  ar: {
    ...
    hello: 'السلام',
    intro: 'هاهي الإحصائيات ديالك ف JitPlus هاد السيمانة:',
...
const REFERRAL: Record<Lang, {
  ...
  ar: {
    pre: 'عيط لتاجر على JitPlus واربح 25 درهم بونوس!',
    h: '💰 بارطاجي واربح 25 درهم!',
    hello: 'السلام',
    p1: (accent) => `واش كتعرف تاجر بغا يفيّد الزبناء ديالو؟ عيط ليه لـ <strong style="color: ${accent};">JitPlus</strong> واخد <strong>25 درهم بونوس</strong> ملي يشري الاشتراك بريميوم!`,
    steps: [
...
const FEATURE_STAMPS: Record<Lang, {
  ...
  ar: {
    ...
    h: '📋 واش كنتي تعرف؟',
    hello: 'السلام',
    p1: (accent) => `بعض المحلات ف JitPlus كيقدمو <strong style="color: ${accent};">كارطات الطوابع</strong>. ف كل زيارة كتجمع طابع. ملي تكمل الكارطة، كتاخد كادو فابور!`,
...
const FEATURE_QR: Record<Lang, {
  ...
  ar: {
    ...
    h: '📱 سكاني = اربح!',
    hello: 'السلام',
    intro: 'مع JitPlus، كل شراء كيجيب ليك نقط. كيفاش كتخدم؟',
    steps: [
