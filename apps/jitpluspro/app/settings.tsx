            ...
            <View>
              ...
              <View style={[styles.conversionRuleCard, { backgroundColor: theme.bg, borderColor: theme.primary + '40' }]}>
                ...
                {(() => {
                  ...
                  const rate = x / y;
                  const exampleIn = 100;
                  // User typed "X fromUnit = Y toUnit", so 1 fromUnit = (y/x) toUnit
                  // → exampleIn fromUnit = exampleIn / rate toUnit (symmetric for both directions).
                  // STAMPS direction floors (stamps must be whole), POINTS rounds.
                  ...
                  return (
                    <View style={[styles.rewardConversionPreview, { borderTopColor: theme.border }]}>
                      ...
                      {rewards.map((r) => {
                        ...
                        // new_cost = old_cost / rate, where rate = x / y.
